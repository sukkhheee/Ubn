...
export function HeaderLarge() {
    ...
    //req.open('POST', 'https://tusliinajil.firebaseio.com/tses.json');
    // req.setRequestHeader('Content-Type', 'application/json');
    //req.onload = function () {
    //console.log('res', req.response);
    // };
    //req.send(JSON.stringify({tsesElement: 'ыбйыб'}));


    if (loading) {
        var req = new XMLHttpRequest();
        req.open('GET', 'https://tusliinajil.firebaseio.com/tses.json');
                ...
                if (res[property].tsesElement) {
                    ...
                    d.push(React.createElement(
                        ...
                        React.createElement(
                            'a',
                            { href: '/' },
                            React.createElement('img', { src: res[property].imageSrc })
                        )
                    ));
                }
            } //console.dir(d);
